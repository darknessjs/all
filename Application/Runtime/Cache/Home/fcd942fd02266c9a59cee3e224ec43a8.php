...
<head>
    ...
    <script language="JavaScript">
       ...
       var __APP="/newsc/web/index.php";
        var __SELF="/newsc/web/index.php/Home/Setting/warningsetting";
...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary openRwindow" data-w-target="#addwarning" data-w-title="添加报警"><i class="fa fa-plus"></i> 添加报警</button>
        ...
        <div class="row settingrow">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-striped warningtable">
                        <thead>
                        <tr>
...
<div class="R_windows" id="addwarning" data-height="600">
    <div class="R_windows_head">

        <div class="R_windows_title">添加报警</div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group alarm_name">
                    <label><span class="maincolor musthave">*</span>报警名</label>
                    <input class="form-control">
                </div>
                <div class="form-group alarm_rule">
                ...
                <div class="form-group">
                    ...
                    <label class="checkbox-inline">
                        <input type="checkbox" class="alarm_sound">声音
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" class="alarm_email">邮件
                    </label>
                </div>
                <div class="form-group">
                    <label>立即生效：</label>
                    <span class="R_switch" data-on="on" data-off="off" data-ison="true"></span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <button class="btn btn-primary warningsetting_ok">确定</button>
...
<script type="text/javascript" src="/newsc/web/Public/js/warningsetting-js.js"></script>
