...
<head>
    ...
    <script language="JavaScript">
       ...
       var __APP="/newsc/web/index.php";
        var __SELF="/newsc/web/index.php/Home/Index/warning";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    ...
                    <table class="warningtable table table-bordered table-hover table-striped">
                        <thead>
                        <tr>
...
<script type="text/javascript" src="/newsc/web/Public/js/warning-js.js"></script>
</div>
