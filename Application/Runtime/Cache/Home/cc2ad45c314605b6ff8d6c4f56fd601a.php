...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" type="text/css" href="/newsc/web/Public/css/bootstrap-material-design.min.css" />
    ...
    <link rel="stylesheet" type="text/css" href="/newsc/web/Public/css/ripples.min.css" />
    ...
    <script type="text/javascript" src="/newsc/web/Public/js/material.min.js"></script>
    <script type="text/javascript" src="/newsc/web/Public/js/ripples.min.js"></script>
    ...
    <script language="JavaScript">
       ...
       var __APP="/newsc/web/index.php";
        var __SELF="/newsc/web/index.php/Home/Setting/answersetting";
...
<link rel="stylesheet" type="text/css" href="/newsc/web/Public/css/kalendae.css" />
<script type="text/javascript" src="/newsc/web/Public/js/kalendae.standalone.js"></script>
...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary openRwindow" data-w-title="添加任务" data-w-target="#addwarning"><i class="fa fa-plus"></i> 添加任务</button>
                <button class="btn btn-info alldelete" data-toggle="modal" data-target="#myModal" ><i class="fa fa-trash-o"></i> 批量删除</button>
                <button class="btn btn-success allstart">开始</button>
                <button class="btn btn-danger allstop" >停止</button>
            </div>
        </div>
        ...
        <div class="row settingrow">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="anwsertable table table-bordered table-hover table-striped">
                        <thead>
                        <tr>
...
<div class="R_windows" id="addwarning" data-height="650">
    <div class="R_windows_head">
        <div class="R_windows_title">添加任务</div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group is-empty task_name">
                    <label class="control-label col-lg-2" for="15ps"><span class="maincolor musthave">*</span>任务名称</label>
                    <div class="col-lg-10">
                        <input class="form-control col-lg-10">
                    </div>
                </div>
                <div class="form-group url_start">
                    <label><span class="maincolor musthave">*</span>采集来源</label>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group page_count">
                    <label><span class="maincolor musthave">*</span>每次采集条数</label>
                    <input class="form-control">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="form-group count_thread_max">
                    <label><span class="maincolor musthave">*</span>爬虫数量</label>
                    <input class="form-control">
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group schedule_type">
                    <label><span class="maincolor musthave">*</span>执行时间</label>
                    <select class="form-control">
                        <option value="1">立即执行</option>
                        <option value="2">计划执行</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="row dataselect">
            <div class="col-lg-6">
                <div class="form-group dataselect">
                    <label><span class="maincolor musthave">*</span>选择日期</label>
                    <button class="form-control">日期</button>
                    <div id="dataselect"></div>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group data-hour">
                    <label>时</label>
                    <input class="form-control">
                </div>
            </div>
            <div class="col-lg-3">
                <div class="form-group data-minute">
                    <label>分</label>
                    <input class="form-control">
                </div>
            </div>
        ...
        <div class="row time_interval">
            <div class="col-lg-3 ">
                <div class="form-group time_interval_checkbox">
                    <label>是否重复</label>
                    <input type="checkbox" class="form-control" style="height: 34px; width: auto;margin-left: 20px;">
                </div>
            </div>
            <div class="col-lg-9 time_interval_input">
                <div class="form-group time_interval_input time_interval_input_val">
                    <label><span class="maincolor musthave">*</span>重复执行间隔</label>
                    <input class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group rule_match">
                    <label><span class="maincolor musthave">*</span>内容抓取规则</label>
                    <textarea class="form-control" id="rule_textarea"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <label>立即开始：</label>
                    <span class="R_switch" data-on="开始" data-off="停止"></span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <button class="btn btn-primary answersetting_ok">确定</button>
...
<script type="text/javascript" src="/newsc/web/Public/js/answersetting-js.js"></script>
</div>
