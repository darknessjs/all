...
<head>
    ...
    <script language="JavaScript">
       ...
       var __APP="/newsc/web/index.php";
        var __SELF="/newsc/web/index.php/Home/Setting/searchsetting";
...
<div class="R_windows" id="addwarning" data-height="580">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group task_name">
                    <label><span class="maincolor musthave">*</span>任务名称</label>
                    <input class="form-control">
                </div>
                <div class="form-group search_key">
                    <label><span class="maincolor musthave">*</span>关键词</label>
                    <input class="form-control">
                </div>

                <div class="form-group search_net">
                    <label><span class="maincolor musthave">*</span>采集网站</label>
        ...
        <div class="row">
            <div class="col-lg-6">
                <button class="btn btn-primary searchsetting_ok">确定</button>
...
<script type="text/javascript" src="/newsc/web/Public/js/searchsetting-js.js"></script>
</div>
