...
<head>
    ...
    <script language="JavaScript">
       ...
       var __APP="/newsc/web/index.php";
        var __SELF="/newsc/web/index.php/Home/Setting/usersetting";
...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary openRwindow" data-w-target="#addwarning" data-w-title="添加新用户"><i class="fa fa-plus"></i> 添加新用户</button>
        ...
        <div class="row settingrow">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="usertable table table-bordered table-hover table-striped">
                        <thead>
                        <tr>
...
<div class="R_windows" id="addwarning">
    <div class="R_windows_head">
        <div class="R_windows_title">添加新用户</div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="form-group username">
                    <label><span class="maincolor musthave">*</span>用户名</label>
                    <input class="form-control">
                </div>
                <div class="form-group password">
                    <label><span class="maincolor musthave">*</span>密码</label>
                    <input type="password" class="form-control">
                </div>
                <div class="form-group rppassword">
                    <label>密码确认</label>
                    <input type="password" class="form-control">
                </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <button class="btn btn-primary addUserButton">确定</button>
...
<script type="text/javascript" src="/newsc/web/Public/js/usersetting-js.js"></script>
</div>
